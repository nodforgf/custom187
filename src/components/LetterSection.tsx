                            ...
                            <div className="bg-[#fff8fb] rounded-2xl shadow-[0_20px_50px_rgba(232,120,154,0.25)] border border-[#f4a7be]/40 overflow-hidden">
                                ...
                                <div className="px-7 py-6 text-[#c2547a] space-y-4">
                                    ...
                                    <div className="text-xs leading-7 space-y-3 italic text-[#c2547a]/75">
                                        <p>เค้าดีใจที่มีเธอเข้ามาในชีวิต ถึงมันจะยังไม่นานแต่เค้ามีความสุขมากกกก ตั้งแต่วันนั้นจนวันนี้เค้าไม่เคยรู้สึกว่าตัวคนเดียวอีกเลย ขอบคุณที่อยู่ข้างๆกันในวันแย่ๆ ทะเลาะกันแค่ไหนเธอก็จะกอดเค้าเสมอ เค้าขอโทษกับเรื่องที่ผ่านมา เค้าไม่อยากให้ที่รักคิดมาก เค้าเลือกเธอและจะเป็นเธอเสมอ เรารักกันมันดีมากๆเลย อยู่ด้วยกันไปตลอดเลยนะคะ เค้ารักเธอที่สุด 
​</p>
                                    </div>
