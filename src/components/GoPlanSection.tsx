...
const WISHES = [
  { id: 1,  text: "ไปดินเนอร์ที่ร้านอาหารกัน 2 คน",                color: "#ffd6e7" },
  { id: 2,  text: "ไปนั่งดูพระอาทิตย์ตกที่ทะเลด้วยกัน", color: "#fce4ec" },
  { id: 3,  text: "ตามใจเธอ 1 วัน อยากทำอะไรก็ได้",        color: "#fff0f8" },
  { id: 4,  text: "ทำอาหารกินเองด้วยกันในวันหยุด",           color: "#ffd6e7" },
  { id: 5,  text: "ขับรถไปเที่ยวต่างจังหวัดกันแบบไม่มีแผน",          color: "#fce4ec" },
  { id: 6,  text: "ไปทำกิจกรรมด้วยกันแบบไม่จับมือถือสัก 1 ชม.",  color: "#fff0f8" },
  { id: 7,  text: "ไปร้องคาราโอเกะกัน 2 คน",          color: "#ffd6e7" },
  { id: 8,  text: "Deep talk คุยกันแบบเปิดใจ",         color: "#fce4ec" },
  { id: 9,  text: "ไปนั่งจิบเบียร์ที่สงบๆกัน 2 คน",            color: "#fff0f8" },
  { id: 10, text: "ไปทำบุญด้วยกัน",            color: "#ffd6e7" },
];
