...
function PhotoCard({ photoUrl, idx, style, photoDate }: PhotoCardProps) {
  ...
  const messages = [
    "วันครบรอบเดือนที่แล้วเราไปดูหนังกันเรื่อง เทอม4 ที่รักลืมของไว้ที่โรงหนังด้วย555555",
    "เค้าพาที่รักไปถ่ายใบขับขี่ เราซิ่งมอไซไปด้วยกัน แล้ววันนั้นก็ขับรถกันหัวหมุนมาก จำได้ป่าว",
    "เค้าชอบให้ที่รักหอมแก้มที่สุดในสามโลกเลย ถ้าวันไหนที่เธอไม่หอมเค้าจะนอยนะ แต่ไม่มี55555 ",
    "ที่รักพาลูกไปเล่นที่ Giga park วันนั้นสนุกมาก แล้วลูกก็ไม่ดื้อด้วย",
    "เราไปเที่ยวกับครอบครัวครั้งแรก เค้ามีความสุขที่สุด แล้วที่รักก็คุยกับแม่เรื่องอยากหมั้นกับเค้าด้วย น่ารักมาก",
    "เค้าดีใจที่ตกลงเป็นแฟนกับเธอ ขอบคุณที่รักเค้าและขอโทษที่เคยนิสัยไม่ดีกับเธอ เค้ารักเธอนะปากห้อย",
  ];
